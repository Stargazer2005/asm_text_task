...
extern "C" __attribute__((sysv_abi)) bool CheckProperty(const char* str);
extern "C" __attribute__((sysv_abi)) void ApplyRule1(char* str);
extern "C" __attribute__((sysv_abi)) void ApplyRule2(char* str);
